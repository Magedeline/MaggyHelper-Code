...
#pragma warning restore CS0414
        ...
        {
            // Set up basic properties - use inherited MaxHealth from BossActor
            MaxHealth = 1000;
        ...
        private IEnumerator OrganSlamAttack()
        {
            ...
            // Execute slam
            Audio.Play("event:/desolozantas/char/organic_slam", Position);
        ...
        private IEnumerator VineWhipAttack()
        {
            ...
            Audio.Play("event:/desolozantas/char/vine_whip", Position);
        ...
        private IEnumerator OrganProjectileAttack()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                Audio.Play("event:/desolozantas/char/organ_launch", Position);
                yield return 0.3f;
            }
        }
        ...
        private IEnumerator BoneSpearAttack()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                Audio.Play("event:/desolozantas/char/bone_spike", spearPos);
                yield return 0.15f;
            }
        }
        ...
        private IEnumerator SkullSwarmAttack()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Audio.Play("event:/desolozantas/char/skull_spawn", spawnPos);
                yield return 0.2f;
            }
        }
        ...
        private IEnumerator FemurClubAttack()
        {
            ...
            Audio.Play("event:/desolozantas/char/bone_club", Position);
        ...
        private IEnumerator MuscleTentaclesAttack()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                Audio.Play("event:/desolozantas/char/flesh_grab", tentaclePos);
                yield return 0.4f;
            }
        }
        ...
        private IEnumerator BloodGeyserAttack()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                Audio.Play("event:/desolozantas/char/blood_geyser", geyserPos);
                yield return 0.3f;
            }
        }
        ...
        private IEnumerator NerveShockAttack()
        {
            ...
            Audio.Play("event:/desolozantas/char/nerve_shock", Position);
        ...
        private IEnumerator ChainFlailAttack()
        {
            ...
            Audio.Play("event:/desolozantas/char/chain_swing", Position);
        ...
        private IEnumerator BladeStormAttack()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                Audio.Play("event:/desolozantas/char/blade_spin", Position);
                yield return 0.1f;
            }
        ...
        private IEnumerator BoneMaceAttack()
        {
            ...
            Audio.Play("event:/desolozantas/char/bone_mace", Position);
        ...
        private IEnumerator NightmareBeamAttack()
        {
            ...
            Audio.Play("event:/desolozantas/char/nightmare_beam", Position);
        ...
        private IEnumerator SoulCrushAttack()
        {
            ...
            if (player != null)
            {
                Audio.Play("event:/desolozantas/char/soul_crush", Position);
        ...
        {
            // Distort the arena
            Audio.Play("event:/desolozantas/char/reality_warp", Position);
        ...
        private IEnumerator DespairAuraAttack()
        {
            ...
            Audio.Play("event:/desolozantas/char/despair_aura", Position);
        ...
        private void CollectSoul(string soulType)
        {
            ...
            // Visual effects
            Audio.Play("event:/desolozantas/char/soul_collected", soulPositions[soulType]);
        ...
        private IEnumerator TransformToFinalForm()
        {
            ...
            Audio.Play("event:/desolozantas/char/final_transform", Position);
        ...
        private IEnumerator PlayerFinalAttack()
        {
            ...
            Audio.Play("event:/desolozantas/char/player_soul_blast", player.Position);
