...
[CustomEntity("MaggyHelper/DreamJellyfish")]
[Tracked(true)]
internal class DreamJellyfish : Glider
{
    ...
    {
        var gliderData = new DynamicData(typeof(Glider), this);
        Remove(gliderData.Get<Sprite>("sprite"));
        Add(dreamSprite = new DreamSprite(
        ...
        gliderData.Set("sprite", dreamSprite);
