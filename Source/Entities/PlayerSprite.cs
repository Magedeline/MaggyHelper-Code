    ...
    public class PlayerSprite : Sprite {
            ...
            : base(null, null) // Base initialization
        {
            ...
            switch (characterType) {
                ...
                case PlayerSpriteCharacter.Chara:
                    InitializeFromSpriteMode(PlayerSpriteModeExtensions.Chara);
                    break;
            ...
            : base(null, null) // Base initialization
        {
            ...
            switch (spriteMode) {
                ...
                case PlayerSpriteMode.MadelineNoBackpack: // Note: Madelinealt equals MadelineNoBackpack
                ...
                case PlayerSpriteMode.MadelineAsBadeline:
                    ...
                    break;
                case PlayerSpriteModeExtensions.Chara:
        ...
        private void InitializeFromSpriteMode(PlayerSpriteMode mode) {
            ...
            // Note: Madelinealt equals MadelineNoBackpack, so only include one to avoid duplicate key
            var modeToIdMap = new Dictionary<PlayerSpriteMode, string> {
                { PlayerSpriteModeExtensions.Chara, "maggy_chara" },
                { PlayerSpriteMode.Madeline, "maggy_player" },
                { PlayerSpriteMode.MadelineNoBackpack, "player_no_backpack" }, // Also covers Madelinealt
                ...
                { PlayerSpriteModeExtensions.Default, "maggy_player" } // Default to player if not specified
            };
            ...
            if (modeToIdMap.TryGetValue(mode, out string spriteName)) {
                ...
                GFX.SpriteBank.CreateOn(this, "maggy_player");
            }
        }
