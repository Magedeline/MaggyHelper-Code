namespace MaggyHelper.Entities
{
    ...
    public class RalseiDummy : Entity
    {
        ...
        private void InitializeHair()
        {
            ...
            {
                Hair = null;
                Logger.Log(LogLevel.Debug, "RalseiDummy", "Hair initialization skipped - requires compatible implementation");
            }
            catch (Exception ex)
            {
                Logger.Log(LogLevel.Warn, "RalseiDummy", $"Hair initialization failed: {ex.Message}");
                Hair = null;
            }
        }
